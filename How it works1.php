...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <form class="d-flex">
          <ul class="navbar-nav">
            <li class="nav-item">
              <li class="nav-item">
                <a href="signup.php" class="btn btn-success" role="button">SignUp</a>
              </li>
            </li>
            <li class="nav-item">
              <li class="nav-item">
    ...
    <div class="container">
        ...
        <p>Practically anyone can be a member on CASHCLIP as all you need is an internet enabled device to enable you
        ...
        <ul>
            <li>Scroll down on your dashboard you'll see sponsored post for the day I.e sponsored post for 1th of August
                2022</li>
        ...
        <p>Contact any of the code distributors on the site to get registration code, then go to your dashboard/profile,
      ...
      <section class="newsletter">
        <div class="newsletter-inner">
          <div class="container">
            ...
            <a href="#" class="btn1 btn-inverse">Follow</a> </div>
        </div>
      </section>
